tell application "System Events"
	-- This doesn't work for some Google Chrome contexts (like a small
	-- pop up window that doesn't look like a window visually).
	-- Consider trying to use tabs to get at the underlying window in
	-- that case
